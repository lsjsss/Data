...
int sqlisth1() {
    ...
    int num1 = 0;//顺序表第三个元素的值
    GetElem(L, numlocation1, num1);//查找元素值
    printf("%d\n", num1 );//返回元素值

    printf("顺序表中元素 9 首次出现的位置：");
    int num2 = 9;//顺序表元素值等于9
    printf("%d\n", LocateElem(L, num2));//查找位置

    printf("顺序表中第 7 个位置插入元素 41 之后:");
    int numlocation3 = 7;
    int num3 = 41;
    ListInsert(L, numlocation3, num3);//顺序表中第 7 个位置插入元素 41
    DispList(L);//输出顺序表

    printf("顺序表中删除第 3 个位置元素之后：");
    int numlocation4 = 3;
    int delnum4 = 0;
